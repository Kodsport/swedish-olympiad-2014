...
int main()
{
	...
	if (!validateInput(bestTotalNumberOfBricks, bestLeftNumberOfBricks, bestRightNumberOfBricks))
		cout << "ERROR!\nBest answer is not unique" << endl;

	//Skriv ut det mindre talet först
	if (bestLeftNumberOfBricks > bestRightNumberOfBricks)
		swap(bestLeftNumberOfBricks, bestRightNumberOfBricks);
	cout << bestLeftNumberOfBricks << " " << bestRightNumberOfBricks << endl;
	return 0;
}
