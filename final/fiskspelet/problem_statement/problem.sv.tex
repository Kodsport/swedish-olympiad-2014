...
\begin{itemize}
    \item För 20 delpoäng så gäller det att inga andra fiskar äter upp
          varandra, $n \leq 1\,000$, $h \leq 50$, och x-koordinaterna är små ($\leq 10\,000$).
          Observera att förutom i dessa testfall ryms x-koordinaterna oftast inte i 32-bitars heltal.
